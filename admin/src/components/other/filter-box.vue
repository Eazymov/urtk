  ...
  <md-card class="filter-box" :class="{ 'active': active }">
    <form @submit.prevent="active = false">
      <input type="text"
             ...
             @click="active = true"
             autocomplete="off" />
      <md-tooltip md-delay="500">Введите строку для поиска совпадений</md-tooltip>

      <md-icon class="filter-box__search-icon md-dark md-20">search</md-icon>

      <label for="search-param">Искать в:</label>
    ...
    <md-icon class="filter-box__reset-btn md-dark md-20"
     ...
     <md-tooltip md-delay="500">Сбросить фильтр</md-tooltip>
    </md-icon>
  </md-card>
