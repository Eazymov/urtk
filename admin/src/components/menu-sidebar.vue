  ...
  <md-whiteframe tag="section" md-elevation="6" id='menu-sidebar'>
    ...
    <div class="menu-head">
      ...
      <md-button class='md-icon-button md-fab md-mini menu-head__exit-btn' href='exit.php'>
        ...
        <md-tooltip md-delay="500">Выйти</md-tooltip>
      </md-button>
    </div>
    ...
    <ul class="menu-list">
      ...
      <li class="menu-list__item">
        ...
        <a class='add-btn'
          ...
          <md-tooltip md-delay="500">Добавить спонсора</md-tooltip>
        </a>
      </li>
      <li class="menu-list__item">
          ...
          <transition-group name="categories">
            <li v-for="categorie in categories"
              ...
              <md-button class="md-icon-button md-dense hide-btn"
                ...
                <md-tooltip md-delay="500">Скрыть категорию</md-tooltip>
              </md-button>
  ...
  export default {
    ...
    methods: {
      getData() {
        ...
        this.$http
          .get(`../../../server_scripts/get/categories_list.php?${expires}`)
      ...
      handleDelete(id) {
        this.promptCallback = () => {
          ...
          this.$http
            .post('../../../server_scripts/delete/categorie.php', { id })
            .catch(error => console.log(error));
        }
